...
if(!isset($_COOKIE["username"])){
	header("location: login.php"); //Si NO hay session redirigir a index
}
?>
	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li>
					<a class="waves-effect" href="logout.php"><i class="menu-icon fa fa-power-off"></i><span>Logout</span></a>
				</li>
			</ul>
			<!-- /.menu js__accordion -->
		</div>
...
<div class="fixed-navbar">
	...
	<div class="pull-right">
		...
		<a href="logout.php" class="ico-item fa fa-power-off js__logout"></a>
	</div>
	<!-- /.pull-right -->
</div>
<!-- /.fixed-navbar -->
...
<?php
	if(isset($_GET["vista"])){
		include('vistas/'.$_GET["vista"].'.php');	//"mvc" sensillo
	} else { include('vistas/index.php'); /* vista por default */ }
?>
				</div>
			</div>
		</div>
