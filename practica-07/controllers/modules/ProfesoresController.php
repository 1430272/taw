<?php Class ProfesoresController {
	...
	public function registrar_profesor(){
		if(isset($_POST["no_empleado"])){	//con que se mande cualquier campo, no importa cual sea
			...
			$respuesta = ProfesoresModel::registrar_profesor($datosController, "practica_07_profesores");
...
#				Nucleo::Redirigir("");	//Ir a index
	...
	public function mostrar_profesores(){
		$respuesta = ProfesoresModel::mostrar_profesores("practica_07_profesores");
	...
	public function editar_profesor(){
		...
		$respuesta = ProfesoresModel::editar_profesor($datosController, "practica_07_profesores");
	...
	public function actualizar_profesor(){
		if(isset($_POST["no_empleado"])){
			$datosController = array( "id"=>$_POST["id"],
							          ...
							          "apellido_materno"=>$_POST["apellido_materno"],
				                      "email"=>$_POST["email"]);
			$respuesta = ProfesoresModel::actualizar_profesor($datosController, "practica_07_profesores");
			if($respuesta == "success"){
				Nucleo::Redirigir("lista-profesores");
			} else {
				Nucleo::Alerta("Error");
	...
	public static function borrar_profesor(){
		if(isset($_GET["idBorrar"])){
			...
			$respuesta = ProfesoresModel::borrar_profesor($datosController, "practica_07_profesores");
			if($respuesta == "success"){
				Nucleo::Redirigir("lista-profesores");
			}
		}
